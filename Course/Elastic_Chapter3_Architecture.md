...
ابزار Kibana مثل یه **رابط کاربری گرافیکی** برای Elasticsearch عمل می‌کنه. بدون Kibana، کار با داده‌های خام تو Elasticsearch خیلی سخت و پیچیده‌ست، چون باید با دستورات متنی کار کنی. Kibana این داده‌ها رو ساده و قابل‌فهم می‌کنه.
