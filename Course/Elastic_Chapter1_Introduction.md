...
ابتدا به عنوان یک موتور جستجوی متن‌باز برای جستجوی متن کامل در مقیاس بالا توسعه داده شد و بعدها در کنار ابزارهایی مثل **Logstash** و **Kibana** و **Beats** تبدیل به یک پلتفرم کامل به نام **Elastic Stack** یا به‌اختصار **ELK Stack** شد.
...
---
### اگر در مورد شاخص گذاری (Indexing) اطلاعاتی ندارید ، فایل مربوطه رو بخونید . [Indexing](https://github.com/amirbnprogramming/Elastic/blob/main/Course/Elastic_Chapter0_CrashConcepts.md)
---
